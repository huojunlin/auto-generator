...
//		SELECT STUFF((select ',"' + name +'"' from sysobjects where xtype='u' for xml path('')),1,1,'')
		...
		// 1.生成数组中所有表名对应的
		String[] tableNames = new String[] { "Activate","Alarm","AppUser","FireState","Message","Owner","OwnerVehicle","Param","ParamSetup","Position","SecurityContext","ServiceStatus","SmsCommand","UserVehicle","Vehicle","VehicleCondition","VehicleType"};
